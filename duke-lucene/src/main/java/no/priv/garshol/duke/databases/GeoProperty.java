...
/**
 * All spatial Lucene search functionality is located in this class. The class
 * serves no natural design function, but moving all the dependencies out here
 * ensures that people who don't need the geosearch can use Duke without the
 * spatial libraries.
 */
